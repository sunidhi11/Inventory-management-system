...
<body>
	...
	<fieldset style="width:70%;">
		...
		<form action="adminlogin" method="POST" style="background-color:ghostwhite;">
			<table cellspacing="30px" style="border:1px solid ghostwhite;border-collapse: separate; border-spacing: 20px;font-size:25px;color:#f51c7f;">				
				...
				<tr><td>Password 1</td><td><input type="password" name="pass1"></td></tr>
				<tr><td>Password 2</td><td><input type="password" name="pass2"></td></tr>
